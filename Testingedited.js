...
let names = [" ","Jose","Mark Cameron Richmond","Si Hu","Zachary Colangelo","Abcdefghijklmnop Qrstuvwxyzabcdefghijklmnopshidbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb"];
...
for (i = 0; i < 35; i++){
   ...
   if (name == " ")
      console.log("There was no Name Entered")
   else
